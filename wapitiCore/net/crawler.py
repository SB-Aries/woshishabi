...
def retry(delay=1, times=3):
    ...
    or HTTP 502 Bad Gateway errors
        ...
        async def inner_wrapper(*args, **kwargs):
            ...
            for counter in range(times):
                ...
                try:
                    ...
                    # If we get a 502 Bad Gateway, retry the request
                    if hasattr(value, 'status') and value.status == 502:
                        final_excep = httpx.NetworkError("HTTP 502 Bad Gateway")
                        continue
                    return value
